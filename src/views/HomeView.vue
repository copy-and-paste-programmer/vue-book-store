<template>
    <div class="flex">
        ...
        <div class="flex-1 bg-primary">
            <div class="w-full flex bg-secondary justify-center rounded-tl-[3.5rem]">
                <div class="p-10">
                    <!-- search -->
                    <div class="relative">
                        <div class="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
                            <svg
                                aria-hidden="true"
                                class="w-5 h-5 text-[#fff] dark:text-gray-400"
                                fill="none"
                                stroke="currentColor"
                                viewBox="0 0 24 24"
                    ...
                    <!-- hi lara -->
                    <div class="lara w-full bg-[#2B335B] mt-10 rounded-lg h-44 relative">
                        <div class="mx-auto w-11/12 grid grid-cols-2">
                            <div class="left w-8/12 mt-5">
                                <h2 class="text-[#fff] text-xl font-bold dark:text-white">
                                    Hi Lara!
                                </h2>
                                <p class="text-[#fff] my-3">
                                    Here is a customised world of books for you.
                                </p>
                                <button
                                    type="button"
                            ...
                            <div class="right w-6/12 absolute right-[-8%] top-[-38%]">
                                <img
                    ...
                    <div class="mt-5">
                        ...
                        <div class="flex grid-cols-2">
                            <div class="left flex grid-cols-2 items-center">
                                <img
                                    src="../../public/images/book1.svg"
                                    alt=""
                                >
                                <div class="">
                                    <h4 class="text-[#fff]">Human Flourishing</h4>
                                    <small class="text-[#5D6495]">By Elliott Holt &nbsp;| &nbsp;Feb 2020</small>
                                    <!-- yellow star -->
                                    <div class="flex py-2">
                                        <svg
                                            xmlns="http://www.w3.org/2000/svg"
                                    ...
                                    <p class="text-[#fff]">Lorem Ipsum is simply dummy text of the printing and typesetting
                                        industry. when an unknown printer.</p>
                                </div>
                            </div>
                            <div class="right flex grid-cols-2 items-center">
                                <img
                                    src="../../public/images/book1.svg"
                                    alt=""
                                >
                                <div class="">
                                    <h4 class="text-[#fff]">Bald Bearded Boss</h4>
                                    <small class="text-[#5D6495]">By Elliott Holt &nbsp;| &nbsp;Feb 2020</small>
                                    <!-- yellow star -->
                                    <div class="flex py-2">
                                        <svg
                    ...
                    <div class="flex pb-[70px] pt-[15px]">
                        <div class="flex items-center mr-[26px]">
                            ...
                            <div class="">
                                ...
                                <span class="text-gray-400 text-xs">By Mena Mum | Feb 2020</span>
                                <div class="flex py-2">
                                    <svg
                                        xmlns="http://www.w3.org/2000/svg"
                                        fill="none"
        ...
        <div class="w-[17%] bg-primary sticky h-screen top-0">
            <div class="p-5">
                ...
                <div class="flex-col flex justify-center items-center text-white mt-12">
                    <img
                        class="w-16 h-16 rounded-full mx-2"
                        :src="ProfileImage"
                        alt="Rounded avatar"
                    >
                    <h2 class="text-sm mt-3">Lara Smith</h2>
                    <p class="text-xs mt-1">laras@gmail.com</p>
                    <svg
                        xmlns="http://www.w3.org/2000/svg"
                        fill="none"
                        viewBox="0 0 24 24"
            ...
            <div class="mt-4 bg-gray-700 h-[0.2px]"></div>
            <div class="p-5">
                <div class="flex">
                    <div class="px-5 bg-[#2B335B] justify-center items-center flex rounded-lg mr-5">
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            fill="none"
                            viewBox="0 0 24 24"
                            stroke-width="1.5"
                            stroke="currentColor"
                            class="w-6 h-6 fill-slate-300 text-slate-300"
                        >
                            <path
                                stroke-linecap="round"
                                stroke-linejoin="round"
                    ...
                    <ul class="text-white flex-col items-start">
                        <li class="flex items-center">
                            ...
                            <p class="text-xs ml-1">Wishlist</p>
                        </li>
                        <li class="mt-1">
                            <p class="text-xs text-slate-400">13 Books</p>
                        </li>
                        <li class="flex items-center mt-1">
                            ...
                            <p class="text-xs ml-1">Private</p>
                        </li>
                    </ul>
                </div>
                <div class="flex mt-5">
                    <div class="px-5 bg-[#2B335B] justify-center items-center flex rounded-lg mr-5">
                        <svg
                            ...
                            stroke-width="1.5"
                            stroke="currentColor"
                            class="w-6 h-6 fill-slate-300 text-slate-200"
                        >
                            <path
                                stroke-linecap="round"
                                stroke-linejoin="round"
                    ...
                    <ul class="text-white flex-col items-start">
                        <li class="flex items-center">
                            ...
                            <p class="text-xs ml-1">Read Books</p>
                        </li>
                        <li class="mt-1">
                            <p class="text-xs text-slate-400">13 Books</p>
                        </li>
